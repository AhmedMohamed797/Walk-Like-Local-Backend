...
const questionSchema = new mongoose.Schema(
  {
    ...
    ttsMimeType: { type: String, default: "audio/mpeg" },
  },
  { _id: false },
);
...
const integrityEventSchema = new mongoose.Schema(
  {
    type: { type: String, enum: INTEGRITY_EVENT_TYPE_VALUES, required: true },
...
const languageTestSessionSchema = new mongoose.Schema(
  {
    ...
    status: { type: String, enum: SESSION_STATUS_VALUES, default: "IN_PROGRESS" },
    questions: { type: [questionSchema], default: [] },
    answers: { type: [answerSchema], default: [] },
    evaluation: { type: evaluationSchema, default: null },
    integrityEvents: { type: [integrityEventSchema], default: [] },
    integrityResult: { type: integrityResultSchema, default: null },
...
const LanguageTestSession = mongoose.model("LanguageTestSession", languageTestSessionSchema);
